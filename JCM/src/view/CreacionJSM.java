...
public class CreacionJSM extends javax.swing.JFrame implements Runnable {
    ...
    public CreacionJSM(ArrayList<String> tablas, boolean controladores, Properties propiedade, Conecion c, String Folder, String folder2, int temp) throws IOException, SQLException {
        initComponents();
    ...
    public void run() {
        ...
        while (ct == Hilo1) {
            try {
                ...
                Logger.getLogger(CreacionJSM.class.getName()).log(Level.SEVERE, null, ex);
            } catch (SQLException ex) {
                Logger.getLogger(CreacionJSM.class.getName()).log(Level.SEVERE, null, ex);
